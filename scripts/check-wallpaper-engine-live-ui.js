...
async function main() {
  ...
  assert(/^stellaflix-wallpaper:\/\//.test(result.applied.imageSrc || result.applied.videoSrc));
  ...
  assert(/^stellaflix-wallpaper:\/\/preview\//.test(result.previewApplied.imageSrc));
