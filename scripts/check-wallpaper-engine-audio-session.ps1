...
namespace Stellaflix.CoreAudioReadOnly {
...
if (-not ([System.Management.Automation.PSTypeName]'Stellaflix.CoreAudioReadOnly.AudioSessionInspector').Type) {
...
do {
  $sampleNumber += 1
  $sessions = @([Stellaflix.CoreAudioReadOnly.AudioSessionInspector]::ReadAllRenderSessions())
