...
public static class StellaflixWeQaWindowList {
...
if ($Move) {
  [StellaflixWeQaWindowList]::Move($TitlePrefix, $X, $Y, $Width, $Height) | Out-Null
}
@([StellaflixWeQaWindowList]::Run($TitlePrefix)) | ConvertTo-Json -Depth 4
