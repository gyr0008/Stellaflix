...
window.addEventListener('mouseup', function (e) {
  ...
  idleGuidePointerUp();
  if (window.StellaflixSonicTopography && StellaflixSonicTopography.isActive(fx) && !mouseDownAt.hadDrag && !isPointerOverUi(e)) {
    ...
    StellaflixSonicTopography.pointerRipple(nx, nz, strength);
  }
});
