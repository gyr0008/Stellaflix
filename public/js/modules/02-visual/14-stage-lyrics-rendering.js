...
function cancelStageLyricPrewarmBuildOnly() {
  ...
  if (typeof window !== 'undefined' && window.__stellaflixLyricBuildStats) {
    window.__stellaflixLyricBuildStats.active = false;
  }
}
...
function cancelStageLyricResidentBuild() {
  ...
  if (typeof window !== 'undefined' && window.__stellaflixLyricResidentStats) {
    window.__stellaflixLyricResidentStats.active = false;
  }
}
...
function finishStageLyricResidentBuild(job) {
  ...
  if (typeof window !== 'undefined') {
    window.__stellaflixLyricResidentStats = {
...
function updateStageLyricBuildStats(job, active, chunkMs) {
  ...
  var stats = window.__stellaflixLyricBuildStats || {};
  ...
  window.__stellaflixLyricBuildStats = stats;
}
...
function startStageLyricCooperativePrewarm(payload, key, token, lightweight, reason) {
  ...
  if (typeof window !== 'undefined') {
    window.__stellaflixLyricBuildStats = {
      active: true,
      reason: job.reason,
