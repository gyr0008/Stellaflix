...
function makeLyricMask(input, layoutOverride) {
  ...
  tex.userData.__stellaflixLyricOwned = true;
...
function makeLyricQualityTexture(mask, tier) {
  ...
  texture.userData.__stellaflixLyricOwned = true;
  texture.userData.__stellaflixLyricQuality = true;
  texture.userData.__stellaflixLyricQualityBytes = target.bytes;
...
function compactLyricLineMaskTexture(mask) {
  ...
  compactTexture.userData.__stellaflixLyricOwned = true;
  ...
  originalTexture.userData.__stellaflixDisposed = true;
