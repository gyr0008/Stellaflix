...
function lyricQualityDisposeTexture(texture) {
  ...
  else if (!texture.userData || !texture.userData.__stellaflixDisposed) {
...
function lyricQualityOwnerActive(data, row) {
  return !!(
    data && data.__stellaflixLyricQualityDisposed !== true &&
...
function updateLyricQualityStats(tier) {
  ...
  window.__stellaflixLyricQualityStats = {
...
function disposeLyricQualityOwner(data) {
  if (!data) return;
  data.__stellaflixLyricQualityDisposed = true;
...
function resetLyricRenderUploadFrameBudget(deferQualityFinalize) {
  ...
  if (typeof window !== 'undefined') {
    window.__stellaflixLyricUploadBudgetStats = {
