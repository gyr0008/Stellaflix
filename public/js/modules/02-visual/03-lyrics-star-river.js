...
function disposeOwnedLyricTexture(texture) {
  if (!texture || !texture.userData || !texture.userData.__stellaflixLyricOwned || texture.userData.__stellaflixDisposed) return;
  texture.userData.__stellaflixDisposed = true;
  texture.dispose();
}
...
function flushLyricDisposeQueue() {
  ...
  if (typeof window !== 'undefined') {
    window.__stellaflixLyricDisposeStats = {
...
function disposeLyricMesh(mesh) {
  if (!mesh || mesh.userData && mesh.userData.__stellaflixDisposeQueued) return;
  mesh.userData = mesh.userData || {};
  mesh.userData.__stellaflixDisposeQueued = true;
