...
function ensureSonicWorkshopCoverPaletteForUi() {
  ...
  img.onload = function () {
    ...
    try {
      ...
      if (window.StellaflixSonicWorkshop && typeof StellaflixSonicWorkshop.pushProperties === 'function') StellaflixSonicWorkshop.pushProperties(true);
    } catch (e) {
...
function pushSonicWorkshopColorChange(reason) {
  updateSonicWorkshopColorControls();
  var workshop = window.StellaflixSonicWorkshop;
