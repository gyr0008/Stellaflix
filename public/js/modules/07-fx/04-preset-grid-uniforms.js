...
function setPreset(p, opts) {
  ...
  if (changed && window.StellaflixSonicTopography) StellaflixSonicTopography.onPresetChange(prev, p, { scene: scene, fx: fx });
  if (changed && window.StellaflixSonicWorkshop) StellaflixSonicWorkshop.onPresetChange(prev, p, { scene: scene, fx: fx });
