...
var AUDIO_FADE_STORE_KEY = 'stellaflix-audio-fade-v1';
...
var CUSTOM_LYRIC_FONT_STORE_KEY = 'stellaflix-custom-lyric-fonts-v1';
...
var CURRENT_FX_AUTOSAVE_STORE_KEY = 'stellaflix-current-fx-autosave-v1';
...
var AUDIO_OUTPUT_DEVICE_STORE_KEY = 'stellaflix-audio-output-device-v1';
var AUDIO_OUTPUT_MIRROR_STORE_KEY = 'stellaflix-audio-output-mirror-v1';
var AUDIO_INPUT_BRIDGE_STORE_KEY = 'stellaflix-audio-input-bridge-v1';
var PROVIDER_VIP_AUDIT_STORE_KEY = 'stellaflix-provider-vip-audit-v1';
var QQ_PLAYBACK_VIP_EVIDENCE_STORE_KEY = 'stellaflix-qq-playback-vip-evidence-v1';
var LOGIN_COOKIE_EXPORT_STORE_KEY = 'stellaflix-login-cookie-export-v1';
var PLAYBACK_QUALITY_DEFAULTS = { netease: 'hires', qq: 'lossless', kugou: 'lossless', qishui: 'standard', spotify: 'standard', 'lx-custom-source': 'hires' };
var PLAYBACK_QUALITY_OPTIONS = {
  ...
  'lx-custom-source': [
    { key: 'hires', title: '自定义音源推荐', sub: '按照脚本支持规格尝试，脚本侧会自行退化' },
    { key: 'lossless', title: '无损 FLAC', sub: '优先无损' },
    { key: 'exhigh', title: '极高 HQ', sub: '320kbps' },
    { key: 'standard', title: '标准', sub: '128kbps' }
  ]
};
...
var PLAYLIST_PANEL_TAB_STORE_KEY = 'stellaflix-playlist-panel-tab-v1';
...
var CLOSE_BEHAVIOR_STORE_KEY = 'stellaflix-close-behavior-v1';
var LAST_PLAYBACK_STORE_KEY = 'stellaflix-last-playback-v1';
var STARTUP_AUTOPLAY_STORE_KEY = 'stellaflix-startup-autoplay-v1';
var STARTUP_FAST_SKIP_STORE_KEY = 'stellaflix-startup-fast-skip-v1';
var STARTUP_RESUME_MODE_STORE_KEY = 'stellaflix-startup-resume-mode-v1';
