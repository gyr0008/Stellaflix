...
function collectRuntimePerfSnapshot(now) {
  ...
  return {
    ...
    probe: (window.__stellaflixPerf && window.__stellaflixPerf.summary)
      ? window.__stellaflixPerf.summary()
      : null
  };
}
window.__stellaflixPerfSnapshot = collectRuntimePerfSnapshot;
