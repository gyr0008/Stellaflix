...
function playbackStallRecoveryOwnerStillCurrent(media, src, token, recoverySerial, queueKey) {
  ...
  if (queueKey && String(media.__stellaflixQueueItemKey || '') !== queueKey) return false;
...
function schedulePlaybackStallRecovery(reason, opts) {
  ...
  var queueKey = String(opts.ownerQueueItemKey || media.__stellaflixQueueItemKey || '');
  if (queueKey && String(media.__stellaflixQueueItemKey || '') !== queueKey) return;
...
function playbackMediaMatchesCurrentQueueItem(media) {
  ...
  var mediaKey = String(media.__stellaflixQueueItemKey || '');
