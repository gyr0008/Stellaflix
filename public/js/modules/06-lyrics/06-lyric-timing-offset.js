var LYRIC_TIMING_OFFSET_STORE_KEY = 'stellaflix-lyric-timing-offsets-v1';
...
function handleLyricTimingOffsetClick(e) {
  if (e && e._stellaflixLyricTimingHandled) return;
  ...
  if (e) {
    e._stellaflixLyricTimingHandled = true;
    e.preventDefault();
    e.stopPropagation();
  }
...
function bindLyricTimingOffsetControls() {
  var root = document.getElementById('lyric-timing-control');
  if (!root || root._stellaflixLyricTimingBound) return;
  root._stellaflixLyricTimingBound = true;
