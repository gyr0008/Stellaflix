/**
 * Sonic Topography visual preset for Stellaflix.
 * Visual algorithm ported from yin-yizhen/sonic-topography 1.1.1 (commit 3ff303e).
 * Only the visual layer is embedded here; player, login and server logic stay Stellaflix-native.
 */
(function (global) {
  'use strict';
  ...
  function readStellaflixAudio(raw) {
    raw = raw || {};
  ...
  function update(dt, ctx) {
    ...
    var audio = readStellaflixAudio(ctx.audio || {});
  ...
  global.StellaflixSonicTopography = {
    INDEX: INDEX,
    isActive: isActive,
    update: update,
    clear: clearLayer,
